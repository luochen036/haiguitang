...
public class AiTest {
    ...
    public void doTest(){
        ...
        final ChatMessage userMessage = ChatMessage.builder().role(ChatMessageRole.USER).content("你知道中国的首都是哪里吗？").build();
        ...
        final ChatMessage streamUserMessage = ChatMessage.builder().role(ChatMessageRole.USER).content("你知道柯南吗？").build();
